...
--
-- -- declare defaults to be used in the DB.lua
-- local defaults = {
--   profile = {
--     setting = true,
--   }
...
local function initdb(sv, defaults, defaultProfile, olddb, parent)
    ...
    if not parent then
        ...
        -- Use the profile of the parents DB.lua
        profileKey = parent.keys.profile or defaultProfile or charKey

        -- clear the profileKeys in the DB.lua, namespaces don't need to store them
        sv.profileKeys = nil
    end
    ...
    -- store the DB.lua in the registry
...
-- @param noChildren if set to true, the reset will not be populated to the child namespaces of this DB.lua object
...
-- By default, an empty DB.lua is created, using a character specific profile.
--
...
-- @usage
-- -- Create an empty DB.lua using a character-specific default profile.
-- self.db = LibStub("AceDB-3.0"):New("MyAddonDB")
-- @usage
-- -- Create a DB.lua using defaults and using a shared default profile
-- self.db = LibStub("AceDB-3.0"):New("MyAddonDB", defaults, true)
